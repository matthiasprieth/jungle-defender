...
(function($) {
	...
	me.game = (function() {
        ...
        api.findGameObject= function(uid){
        ...
        api.getLastGameObject= function(){
		...
		api.collide = function(objA, multiple) {
			...
			for ( var i = gameObjects.length, obj; i--, obj = gameObjects[i];)//for (var i = objlist.length; i-- ;)
			{
				...
				if (obj.inViewport && obj.visible && obj.collidable && (obj!=objA))
                 for objects outside the viewport (by mitch), don`t check obj.visible property
				 */
				if (obj.collidable && (obj!=objA))
				{
